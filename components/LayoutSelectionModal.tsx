...
const LayoutSelectionModal: React.FC<LayoutSelectionModalProps> = ({ onSelect, onClose, stickerStyle, onStickerStyleChange }) => {
            ...
            >
                ...
                <div className="py-2">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <label className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-colors border ${stickerStyle === 'modern' ? 'bg-indigo-50 border-indigo-200 ring-1 ring-indigo-200' : 'bg-slate-50 border-slate-200 hover:bg-slate-100'}`}>
                            <input
                                type="radio"
                                name="stickerStyle"
                                value="modern"
